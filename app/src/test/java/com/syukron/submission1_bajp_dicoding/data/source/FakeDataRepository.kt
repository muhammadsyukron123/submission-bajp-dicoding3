...
class FakeDataRepository (
    ...
    override fun getTVShow(): LiveData<Resource<PagedList<EntityTvShow>>> {
        return object :
            ...
            override fun saveCallResult(data: List<TvShowResponse>) {
                val tvSerialList = ArrayList<EntityTvShow>()
                for (response in data) {
                ...
                localDataSource.insertPopularTvShows(tvSerialList)
            }
    ...
    override fun setTvShowFavorite(tvSerialFavorited: EntityTvShow, state: Boolean) =
        appExecutors.diskIO()
